        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (tmp == 0)
            {
                ...
                if (nodes.Count == 1)
                {
                    ...
                    {
                        e.Graphics.FillEllipse(Brushes.Red, node.X - 5, node.Y - 5, 10, 10);
                    }
                }
            ...
            if (tmp == 1)
            {
                ...
                //在第一个节点处用红色20号宋体输出area的值，保留两位小数
                e.Graphics.DrawString(area.ToString("0.00(mm)"), new Font("宋体", 20), Brushes.Red, ansLocation);
            }
        }
